...
export default function MultiFamilyPropertyManagement() {
      ...
      <section className="relative h-96 flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-light tracking-wide">
            <span className="block font-bold">MULTI-FAMILY PROPERTY MANAGEMENT</span>
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-light mb-6" style={{ color: '#226691' }}>
              EXPERT MULTI-FAMILY PROPERTY MANAGEMENT
            </h2>
            <p className="text-xl text-gray-600 leading-relaxed">
              Norris & Stevens provides comprehensive multi-family property management services that maximize
              your investment returns while ensuring exceptional resident satisfaction and property maintenance.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>Leasing & Marketing</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Our experienced leasing team maximizes occupancy rates through strategic marketing,
                competitive pricing analysis, and exceptional customer service. We attract and retain
                quality residents who treat your property as their home.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
                <li>• Professional marketing and advertising</li>
                <li>• Online listing management</li>
                <li>• Comprehensive tenant screening</li>
                <li>• Market rent analysis and optimization</li>
                <li>• Lease preparation and administration</li>
              </ul>
            </div>

            <div>
              <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>Resident Services</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                We focus on creating positive resident experiences that reduce turnover and maintain
                stable cash flow. Our responsive service approach addresses resident needs promptly
                while protecting your investment interests.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
                <li>• 24/7 emergency maintenance response</li>
                <li>• Online resident portal access</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>Property Maintenance</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Our comprehensive maintenance programs preserve and enhance your property value through
                proactive care and quality repairs. We maintain detailed records and use trusted vendors
                to ensure work is completed efficiently and cost-effectively.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
                <li>• Preventive maintenance programs</li>
                <li>• Unit turnover and preparation</li>
                <li>• Common area maintenance</li>
                <li>• Landscaping and groundskeeping</li>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Our detailed financial management provides complete transparency into your property's
                performance. We handle all aspects of financial operations while providing regular
                reports that help you make informed investment decisions.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
          ...
          <div className="bg-gray-50 p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <h4 className="font-medium mb-2" style={{ color: '#226691' }}>Owner Portal</h4>
                <p className="text-gray-600">24/7 access to financial reports, maintenance requests, and property updates</p>
              </div>
              <div className="text-center">
                <h4 className="font-medium mb-2" style={{ color: '#226691' }}>Resident Portal</h4>
                <p className="text-gray-600">Online rent payments, maintenance requests, and communication tools</p>
              </div>
              <div className="text-center">
                <h4 className="font-medium mb-2" style={{ color: '#226691' }}>Mobile Apps</h4>
                <p className="text-gray-600">Convenient mobile access for residents and property management</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>
              MAXIMIZE YOUR MULTI-FAMILY INVESTMENT
            </h3>
            <p className="text-xl text-gray-600 mb-8">
              Contact our multi-family property management team to learn how we can optimize your returns.
            </p>
            <Link
              href="/contact-us"
