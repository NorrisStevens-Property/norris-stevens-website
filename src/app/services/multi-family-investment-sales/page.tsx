...
export default function MultiFamilyInvestmentSales() {
      ...
      <section className="relative h-96 flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-light tracking-wide">
            <span className="block font-bold">MULTI-FAMILY INVESTMENT SALES</span>
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-light mb-6" style={{ color: '#226691' }}>
              MAXIMIZE YOUR MULTI-FAMILY INVESTMENT RETURNS
            </h2>
            <p className="text-xl text-gray-600 leading-relaxed">
              Norris & Stevens specializes in multi-family investment sales throughout the Pacific Northwest,
              helping investors build wealth through strategic apartment building acquisitions and dispositions.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>Investment Acquisitions</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Our team identifies lucrative multi-family investment opportunities that align with your financial
                goals and risk tolerance. We analyze market trends, cash flow projections, and growth potential
              ...
              <ul className="text-gray-600 space-y-2 mb-6">
                ...
                <li>• Financing assistance and lender connections</li>
                <li>• 1031 exchange facilitation</li>
              </ul>
            </div>

            <div>
              <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>Investment Dispositions</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                When it's time to sell your multi-family investment, our experienced team maximizes your return
                through strategic marketing, competitive positioning, and expert negotiation. We understand
                what investors are looking for and how to present your property effectively.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
                <li>• Property valuation and pricing strategy</li>
                <li>• Professional marketing and listing</li>
          ...
          <div className="bg-gray-50 p-8 mb-16">
            <h3 className="text-2xl font-light mb-4 text-center" style={{ color: '#226691' }}>
              WHY CHOOSE NORRIS & STEVENS FOR MULTI-FAMILY INVESTMENTS?
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <h4 className="font-medium mb-2" style={{ color: '#226691' }}>Market Expertise</h4>
                <p className="text-gray-600">Deep knowledge of Pacific Northwest multi-family markets and trends</p>
              </div>
              <div className="text-center">
                <h4 className="font-medium mb-2" style={{ color: '#226691' }}>Investor Network</h4>
                <p className="text-gray-600">Extensive network of qualified investors and strategic partnerships</p>
              </div>
              <div className="text-center">
                <h4 className="font-medium mb-2" style={{ color: '#226691' }}>Proven Results</h4>
                <p className="text-gray-600">Decades of successful multi-family investment transactions</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>
              READY TO EXPLORE MULTI-FAMILY INVESTMENTS?
            </h3>
            <p className="text-xl text-gray-600 mb-8">
              Contact our multi-family investment specialists to discuss your investment strategy.
            </p>
            <Link
              href="/contact-us"
