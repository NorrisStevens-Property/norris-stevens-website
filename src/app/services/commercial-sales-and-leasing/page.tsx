...
export default function CommercialSalesAndLeasing() {
      ...
      <section className="relative h-96 flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-light tracking-wide">
            <span className="block font-bold">COMMERCIAL SALES & LEASING</span>
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              With decades of experience in the Pacific Northwest commercial real estate market,
              Norris & Stevens provides comprehensive sales and leasing services to help you achieve your investment goals.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>Commercial Sales</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Whether you're looking to acquire or dispose of commercial real estate, our experienced team provides
                expert guidance throughout the entire transaction process. We specialize in office buildings, retail
                centers, industrial properties, and mixed-use developments.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
                <li>• Investment property sales</li>
                <li>• Owner-user building sales</li>
            ...
            <div>
              <h3 className="text-2xl font-light mb-4" style={{ color: '#226691' }}>Commercial Leasing</h3>
              <p className="text-gray-600 leading-relaxed mb-6">
                Our leasing specialists work with both landlords and tenants to negotiate favorable terms and
                find the perfect space for your business needs. From small office suites to large warehouse
                facilities, we have the expertise to get deals done.
              </p>
              <ul className="text-gray-600 space-y-2 mb-6">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Contact our commercial sales and leasing team to discuss your real estate needs.
            </p>
            <Link
              href="/contact-us"
